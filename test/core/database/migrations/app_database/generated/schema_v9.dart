...
class ApprovalRequests extends Table
    with TableInfo<ApprovalRequests, ApprovalRequestsData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ApprovalRequests(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  @override
  ApprovalRequestsData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return ApprovalRequestsData(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}id'],
      )!,
  ...
  @override
  ApprovalRequests createAlias(String alias) {
    return ApprovalRequests(attachedDatabase, alias);
  }
...
class ApprovalRequestsData extends DataClass
    implements Insertable<ApprovalRequestsData> {
  final String id;
  final String organizationId;
  final String branchId;
  final String operationId;
  ...
  factory ApprovalRequestsData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  ApprovalRequestsData copyWithCompanion(ApprovalRequestsCompanion data) {
    return ApprovalRequestsData(
      id: data.id.present ? data.id.value : this.id,
      organizationId: data.organizationId.present
          ? data.organizationId.value
  ...
  @override
  String toString() {
    return (StringBuffer('ApprovalRequestsData(')
          ..write('id: $id, ')
          ..write('organizationId: $organizationId, ')
          ..write('branchId: $branchId, ')
          ..write('operationId: $operationId, ')
...
class ApprovalRequestsCompanion extends UpdateCompanion<ApprovalRequestsData> {
  final Value<String> id;
  final Value<String> organizationId;
  final Value<String> branchId;
  final Value<String> operationId;
  ...
  ApprovalRequestsCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       createdAt = Value(createdAt),
       updatedAt = Value(updatedAt);
  static Insertable<ApprovalRequestsData> custom({
    Expression<String>? id,
    Expression<String>? organizationId,
    Expression<String>? branchId,
    Expression<String>? operationId,
...
class ApprovalDecisions extends Table
    with TableInfo<ApprovalDecisions, ApprovalDecisionsData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ApprovalDecisions(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  @override
  ApprovalDecisionsData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return ApprovalDecisionsData(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}id'],
      )!,
  ...
  @override
  ApprovalDecisions createAlias(String alias) {
    return ApprovalDecisions(attachedDatabase, alias);
  }
...
class ApprovalDecisionsData extends DataClass
    implements Insertable<ApprovalDecisionsData> {
  final String id;
  final String organizationId;
  final String branchId;
  ...
  factory ApprovalDecisionsData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  ApprovalDecisionsData copyWith({
    String? id,
    String? organizationId,
    String? branchId,
  ...
  ApprovalDecisionsData copyWithCompanion(ApprovalDecisionsCompanion data) {
    return ApprovalDecisionsData(
      id: data.id.present ? data.id.value : this.id,
      organizationId: data.organizationId.present
          ? data.organizationId.value
  ...
  @override
  String toString() {
    return (StringBuffer('ApprovalDecisionsData(')
          ..write('id: $id, ')
          ..write('organizationId: $organizationId, ')
          ..write('branchId: $branchId, ')
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is ApprovalDecisionsData &&
          other.id == this.id &&
          other.organizationId == this.organizationId &&
          other.branchId == this.branchId &&
...
class ApprovalDecisionsCompanion
    extends UpdateCompanion<ApprovalDecisionsData> {
  final Value<String> id;
  final Value<String> organizationId;
  final Value<String> branchId;
  ...
  ApprovalDecisionsCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       decidedAt = Value(decidedAt),
       createdAt = Value(createdAt);
  static Insertable<ApprovalDecisionsData> custom({
    Expression<String>? id,
    Expression<String>? organizationId,
    Expression<String>? branchId,
...
class RefundPayments extends Table
    with TableInfo<RefundPayments, RefundPaymentsData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  RefundPayments(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  @override
  RefundPaymentsData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return RefundPaymentsData(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}id'],
      )!,
  ...
  @override
  RefundPayments createAlias(String alias) {
    return RefundPayments(attachedDatabase, alias);
  }
...
class RefundPaymentsData extends DataClass
    implements Insertable<RefundPaymentsData> {
  final String id;
  final String organizationId;
  final String branchId;
  final String saleReturnId;
  ...
  factory RefundPaymentsData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  RefundPaymentsData copyWithCompanion(RefundPaymentsCompanion data) {
    return RefundPaymentsData(
      id: data.id.present ? data.id.value : this.id,
      organizationId: data.organizationId.present
          ? data.organizationId.value
  ...
  @override
  String toString() {
    return (StringBuffer('RefundPaymentsData(')
          ..write('id: $id, ')
          ..write('organizationId: $organizationId, ')
          ..write('branchId: $branchId, ')
          ..write('saleReturnId: $saleReturnId, ')
...
class RefundPaymentsCompanion extends UpdateCompanion<RefundPaymentsData> {
  final Value<String> id;
  final Value<String> organizationId;
  final Value<String> branchId;
  final Value<String> saleReturnId;
  ...
  RefundPaymentsCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       amountMinor = Value(amountMinor),
       createdAt = Value(createdAt);
  static Insertable<RefundPaymentsData> custom({
    Expression<String>? id,
    Expression<String>? organizationId,
    Expression<String>? branchId,
    Expression<String>? saleReturnId,
...
class StockTransfers extends Table
    with TableInfo<StockTransfers, StockTransfersData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  StockTransfers(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  @override
  StockTransfersData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return StockTransfersData(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}id'],
      )!,
  ...
  @override
  StockTransfers createAlias(String alias) {
    return StockTransfers(attachedDatabase, alias);
  }
...
class StockTransfersData extends DataClass
    implements Insertable<StockTransfersData> {
  final String id;
  final String organizationId;
  ...
  factory StockTransfersData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  StockTransfersData copyWithCompanion(StockTransfersCompanion data) {
    return StockTransfersData(
      id: data.id.present ? data.id.value : this.id,
      organizationId: data.organizationId.present
          ? data.organizationId.value
  ...
  @override
  String toString() {
    return (StringBuffer('StockTransfersData(')
          ..write('id: $id, ')
          ..write('organizationId: $organizationId, ')
...
class StockTransfersCompanion extends UpdateCompanion<StockTransfersData> {
  final Value<String> id;
  final Value<String> organizationId;
  ...
  StockTransfersCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       createdAt = Value(createdAt),
       updatedAt = Value(updatedAt);
  static Insertable<StockTransfersData> custom({
    Expression<String>? id,
    Expression<String>? organizationId,
...
class StockTransferItems extends Table
    with TableInfo<StockTransferItems, StockTransferItemsData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  StockTransferItems(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  late final GeneratedColumn<int> shippedQuantityMilli = GeneratedColumn<int>(
    ...
    aliasedName,
    false,
    check: () => const i2.CustomExpression<bool>('shipped_quantity_milli >= 0'),
    type: DriftSqlType.int,
    requiredDuringInsert: false,
    defaultValue: const CustomExpression('0'),
  );
  ...
  late final GeneratedColumn<int> damagedQuantityMilli = GeneratedColumn<int>(
    ...
    aliasedName,
    false,
    check: () => const i2.CustomExpression<bool>('damaged_quantity_milli >= 0'),
    type: DriftSqlType.int,
    requiredDuringInsert: false,
    defaultValue: const CustomExpression('0'),
  );
  ...
  @override
  StockTransferItemsData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
  ...
  @override
  StockTransferItems createAlias(String alias) {
    return StockTransferItems(attachedDatabase, alias);
  }
...
class StockTransferItemsData extends DataClass
    implements Insertable<StockTransferItemsData> {
  final String id;
  final String organizationId;
  ...
  factory StockTransferItemsData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  StockTransferItemsData copyWith({
    String? id,
    String? organizationId,
    String? transferId,
    String? productId,
  ...
  StockTransferItemsData copyWithCompanion(StockTransferItemsCompanion data) {
    return StockTransferItemsData(
      id: data.id.present ? data.id.value : this.id,
      organizationId: data.organizationId.present
          ? data.organizationId.value
  ...
  @override
  String toString() {
    return (StringBuffer('StockTransferItemsData(')
          ..write('id: $id, ')
          ..write('organizationId: $organizationId, ')
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is StockTransferItemsData &&
          other.id == this.id &&
          other.organizationId == this.organizationId &&
...
class StockTransferItemsCompanion
    extends UpdateCompanion<StockTransferItemsData> {
  final Value<String> id;
  final Value<String> organizationId;
  ...
  StockTransferItemsCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       createdAt = Value(createdAt),
       updatedAt = Value(updatedAt);
  static Insertable<StockTransferItemsData> custom({
    Expression<String>? id,
    Expression<String>? organizationId,
...
class TransferEvents extends Table
    with TableInfo<TransferEvents, TransferEventsData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  TransferEvents(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  TransferEventsData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return TransferEventsData(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}id'],
      )!,
  ...
  @override
  TransferEvents createAlias(String alias) {
    return TransferEvents(attachedDatabase, alias);
  }
...
class TransferEventsData extends DataClass
    implements Insertable<TransferEventsData> {
  final String id;
  final String organizationId;
  final String transferId;
  final String operationId;
  ...
  factory TransferEventsData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  TransferEventsData copyWithCompanion(TransferEventsCompanion data) {
    return TransferEventsData(
      id: data.id.present ? data.id.value : this.id,
      organizationId: data.organizationId.present
          ? data.organizationId.value
  ...
  @override
  String toString() {
    return (StringBuffer('TransferEventsData(')
          ..write('id: $id, ')
          ..write('organizationId: $organizationId, ')
          ..write('transferId: $transferId, ')
          ..write('operationId: $operationId, ')
...
class TransferEventsCompanion extends UpdateCompanion<TransferEventsData> {
  final Value<String> id;
  final Value<String> organizationId;
  final Value<String> transferId;
  final Value<String> operationId;
  ...
  TransferEventsCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       occurredAt = Value(occurredAt),
       createdAt = Value(createdAt);
  static Insertable<TransferEventsData> custom({
    Expression<String>? id,
    Expression<String>? organizationId,
    Expression<String>? transferId,
    Expression<String>? operationId,
...
class DatabaseAtV9 extends GeneratedDatabase {
  ...
  late final ApprovalRequests approvalRequests = ApprovalRequests(this);
  late final ApprovalDecisions approvalDecisions = ApprovalDecisions(this);
  late final SaleReturns saleReturns = SaleReturns(this);
  late final SaleReturnItems saleReturnItems = SaleReturnItems(this);
  late final RefundPayments refundPayments = RefundPayments(this);
  late final StockTransfers stockTransfers = StockTransfers(this);
  late final StockTransferItems stockTransferItems = StockTransferItems(this);
  late final TransferEvents transferEvents = TransferEvents(this);
