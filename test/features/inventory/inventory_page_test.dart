...
void main() {
  testWidgets(
    'inventory workspace exposes balances, history, counts, and locations',
    (tester) async {
      ...
      expect(
        tester
            .widget<OutlinedButton>(
              find.widgetWithText(OutlinedButton, 'New location'),
            )
            .onPressed,
        isNull,
      );
      ...
      await tester.pumpAndSettle();
      expect(find.text('No stock locations match this view.'), findsOneWidget);
    },
  );
